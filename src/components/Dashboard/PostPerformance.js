...
const PostPerformance = () => {
  ...
  useEffect(() => {
    ...
    drawBarChartWithImage("typeOfFeedback", typeOfFeedback, "Topic", "Count");
  ...
  return (
    <>
      ...
      <div className="row mt-3">
          ...
          <div className="bg-white rounded p-4 shadow">
            <div className="row">
              <div className="d-flex justify-content-between">
                ...
                <h5 className="text-success">Total: {totalComments}</h5>
              </div>
            </div>
        ...
        <div className="col-md-6">
          <div className="bg-white rounded p-4 shadow">
            <div className="row">
              <div className="d-flex justify-content-between">
                <h5 className="text-primary pb-3">Customer Perception</h5>
                <h5 className="text-success">Total: {totalfFeedback}</h5>
              </div>
            </div>
      ...
      <div className="row mt-3">
        <div className="col-md-12">
          <div className="bg-white rounded p-4 shadow">
            <div className="row">
              <div className="d-flex justify-content-between">
                <h5 className="text-primary pb-3">What people wants to know</h5>
                <h5 className="text-success">Total: {totalQueries}</h5>
              </div>
            </div>
      ...
      <div className="row mt-3 mb-3">
        ...
        <div className="col-md-6">
          <div className="bg-white rounded p-4 shadow">
            <h5 className="text-primary pb-3">Type of Appreciation</h5>
        ...
        <div className="col-md-12">
          <div className="bg-white rounded p-4 shadow">
            ...
            <div className="row mt-4 text-center">
              <div className="col-md-4">
                <a
                  href="https://fb.watch/cmNC3XGnC8"
                  target="_blank"
                  type="button"
